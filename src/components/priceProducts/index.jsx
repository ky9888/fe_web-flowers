...
export default function ComponentProducts({ data }) {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-4 max-custom:grid-cols-2 max-custom:mx-5 max-lg:grid-cols-3 max-lg:mx-10 gap-6 mx-20 text-[14px] font-medium text-slate-800">
        {data &&
          data.length > 0 &&
          data.map((item) => {
            return (
                ...
                >
                  ...
                  >
                    <Image
                      ...
                      // Sử dụng sự kiện 'onLoadingComplete'
                    />
                  </div>
