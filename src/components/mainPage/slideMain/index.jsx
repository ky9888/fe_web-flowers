...
export default function SlideMain() {
  ...
  return (
    <div className="h-[550px] max-custom:h-[170px] max-lg:h-[310px] relative overflow-hidden ">
            ...
            <div key={index} className="w-1/2 relative h-full">
              ...
              {currentImageIndex === 0 && isVisibleText && (
                <div className="absolute text-white max-lg:top-[15%] max-custom:top-0 max-custom:right-[10%] top-[35%] right-[15%] space-y-5 max-custom:space-y-3 cursor-pointer">
                  <p className="text-[30px] font-bold  max-lg:hidden">TIỆM HOA NÀNG THƠM</p>
                  <div className="font-medium">
                    <p className="text-[30px] max-custom:text-[18px] text-center hidden max-lg:block ">TIỆM HOA</p>
                    <p className="text-[30px] max-custom:text-[18px] text-center hidden max-lg:block leading-none">NÀNG THƠM</p>
                  </div>
                  <p className="font-medium text-center max-custom:text-[12px] ">HOA TƯƠI MỖI NGÀY</p>
              ...
              {currentImageIndex !== 0 && isVisible && (
                <div className="absolute transition-all opacity-100 duration-1000 top-0  left-[50%] -translate-x-1/2 bg-[rgba(57,91,56,0.82)] h-full rounded-full max-custom1:w-[45%] max-custom:w-[45%] w-[35%]">
                  <div className="absolute top-0  h-full w-full mt-[20%] max-lg:mt-10 max-custom:space-y-2 space-y-4 text-white">
                    <p className="text-center text-[45px] max-lg:text-[25px] max-custom:text-[12px]">SHOP HOA TƯƠI</p>
                    <p className="text-center text-[45px] max-lg:text-[25px] max-custom:text-[12px]">NÀNG THƠM</p>
                    ...
                    <div className="flex justify-center ">
                      <Link href={"/san-pham"} className="text-[18px] max-custom:text-[12px] max-lg:text-[15px] cursor-pointer mt-2 flex justify-center items-center pt-[1px] pb-[1px] h-full text-center font-medium hover:text-slate-700  hover:bg-white rounded-lg border-2 border-white">
