...
export default function TypeProducts({ data }) {
 ...
 return (
     <>
       <div className="bg-gray-200 flex max-lg:block items-center max-lg:space-y-3 justify-between max-custom:px-1 px-[5%] py-2">
